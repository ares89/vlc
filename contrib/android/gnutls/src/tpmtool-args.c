 ...
 *  
 *  It has been AutoGen-ed  March 22, 2013 at 07:34:48 PM by AutoGen 5.16
...
#define zLicenseDescrip (tpmtool_opt_strs+275)
 ...
 */
static char const tpmtool_opt_strs[2117] =
/*     0 */ "tpmtool 3.1.10\n"
            "Copyright (C) 2000-2012 Free Software Foundation, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the\n"
            "GNU General Public License, version 3 or later\n"
            "    <http://gnu.org/licenses/gpl.html>\n\0"
/*   275 */ "tpmtool is free software: you can redistribute it and/or modify it under\n"
...
/*   945 */ "OUTFILE\0"
/*   953 */ "outfile\0"
/*   961 */ "Generate an RSA private-public key pair\0"
/*  1001 */ "GENERATE_RSA\0"
/*  1014 */ "generate-rsa\0"
/*  1027 */ "Any generated key will be registered in the TPM\0"
/*  1075 */ "REGISTER\0"
/*  1084 */ "register\0"
/*  1093 */ "Any generated key will be a signing key\0"
/*  1133 */ "SIGNING\0"
/*  1141 */ "signing\0"
/*  1149 */ "Any generated key will be a legacy key\0"
/*  1188 */ "LEGACY\0"
/*  1195 */ "legacy\0"
/*  1202 */ "Any registered key will be a user key\0"
/*  1240 */ "USER\0"
/*  1245 */ "user\0"
/*  1250 */ "Any registred key will be a system key\0"
/*  1289 */ "SYSTEM\0"
/*  1296 */ "system\0"
/*  1303 */ "Prints the public key of the provided key\0"
/*  1345 */ "PUBKEY\0"
/*  1352 */ "pubkey\0"
/*  1359 */ "Lists all stored keys in the TPM\0"
/*  1392 */ "LIST\0"
/*  1397 */ "list\0"
/*  1402 */ "Delete the key identified by the given URL (UUID).\0"
/*  1453 */ "DELETE\0"
/*  1460 */ "delete\0"
/*  1467 */ "Specify the security level [low, legacy, normal, high, ultra].\0"
/*  1530 */ "SEC_PARAM\0"
/*  1540 */ "sec-param\0"
/*  1550 */ "Specify the number of bits for key generate\0"
/*  1594 */ "BITS\0"
/*  1599 */ "bits\0"
/*  1604 */ "Use the DER format for keys.\0"
/*  1633 */ "INDER\0"
/*  1639 */ "no-inder\0"
/*  1648 */ "no\0"
/*  1651 */ "Use DER format for output keys\0"
/*  1682 */ "OUTDER\0"
/*  1689 */ "no-outder\0"
/*  1699 */ "Display extended usage information and exit\0"
/*  1743 */ "help\0"
/*  1748 */ "Extended usage information passed thru pager\0"
/*  1793 */ "more-help\0"
/*  1803 */ "Output version information and exit\0"
/*  1839 */ "version\0"
/*  1847 */ "TPMTOOL\0"
/*  1855 */ "tpmtool - GnuTLS TPM tool - Ver. 3.1.10\n"
            "USAGE:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  1953 */ "bug-gnutls@gnu.org\0"
/*  1972 */ "\n\n\0"
/*  1975 */ "\n"
            "Program that allows handling cryptographic data from the TPM chip.\n\0"
/*  2044 */ "tpmtool 3.1.10\0"
/*  2059 */ "tpmtool [options]\n"
            "tpmtool --help for usage instructions.\n";

/*
 *  debug option description:
 */
#define DEBUG_DESC      (tpmtool_opt_strs+878)
#define DEBUG_NAME      (tpmtool_opt_strs+896)
 ...
 */
#define INFILE_DESC      (tpmtool_opt_strs+908)
#define INFILE_NAME      (tpmtool_opt_strs+919)
 ...
 */
#define OUTFILE_DESC      (tpmtool_opt_strs+933)
#define OUTFILE_NAME      (tpmtool_opt_strs+945)
#define OUTFILE_name      (tpmtool_opt_strs+953)
 ...
 */
#define GENERATE_RSA_DESC      (tpmtool_opt_strs+961)
#define GENERATE_RSA_NAME      (tpmtool_opt_strs+1001)
#define GENERATE_RSA_name      (tpmtool_opt_strs+1014)
 ...
 */
#define REGISTER_DESC      (tpmtool_opt_strs+1027)
#define REGISTER_NAME      (tpmtool_opt_strs+1075)
#define REGISTER_name      (tpmtool_opt_strs+1084)
 ...
 *  "Must also have options" and "Incompatible options":
 */
#define SIGNING_DESC      (tpmtool_opt_strs+1093)
#define SIGNING_NAME      (tpmtool_opt_strs+1133)
#define SIGNING_name      (tpmtool_opt_strs+1141)
 ...
 *  "Must also have options" and "Incompatible options":
 */
#define LEGACY_DESC      (tpmtool_opt_strs+1149)
#define LEGACY_NAME      (tpmtool_opt_strs+1188)
 ...
 *  "Must also have options" and "Incompatible options":
 */
#define USER_DESC      (tpmtool_opt_strs+1202)
#define USER_NAME      (tpmtool_opt_strs+1240)
#define USER_name      (tpmtool_opt_strs+1245)
 ...
 *  "Must also have options" and "Incompatible options":
 */
#define SYSTEM_DESC      (tpmtool_opt_strs+1250)
#define SYSTEM_NAME      (tpmtool_opt_strs+1289)
 ...
 */
#define PUBKEY_DESC      (tpmtool_opt_strs+1303)
#define PUBKEY_NAME      (tpmtool_opt_strs+1345)
 ...
 */
#define LIST_DESC      (tpmtool_opt_strs+1359)
#define LIST_NAME      (tpmtool_opt_strs+1392)
#define LIST_name      (tpmtool_opt_strs+1397)
#define LIST_FLAGS     (OPTST_DISABLED)

/*
 *  delete option description:
 */
#define DELETE_DESC      (tpmtool_opt_strs+1402)
#define DELETE_NAME      (tpmtool_opt_strs+1453)
 ...
 */
#define SEC_PARAM_DESC      (tpmtool_opt_strs+1467)
#define SEC_PARAM_NAME      (tpmtool_opt_strs+1530)
#define SEC_PARAM_name      (tpmtool_opt_strs+1540)
 ...
 */
#define BITS_DESC      (tpmtool_opt_strs+1550)
#define BITS_NAME      (tpmtool_opt_strs+1594)
#define BITS_name      (tpmtool_opt_strs+1599)
 ...
 */
#define INDER_DESC      (tpmtool_opt_strs+1604)
#define INDER_NAME      (tpmtool_opt_strs+1633)
#define NOT_INDER_name  (tpmtool_opt_strs+1639)
#define NOT_INDER_PFX   (tpmtool_opt_strs+1648)
 ...
 */
#define OUTDER_DESC      (tpmtool_opt_strs+1651)
#define OUTDER_NAME      (tpmtool_opt_strs+1682)
#define NOT_OUTDER_name  (tpmtool_opt_strs+1689)
#define NOT_OUTDER_PFX   (tpmtool_opt_strs+1648)
 ...
 */
#define HELP_DESC       (tpmtool_opt_strs+1699)
#define HELP_name       (tpmtool_opt_strs+1743)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (tpmtool_opt_strs+1748)
#define MORE_HELP_name  (tpmtool_opt_strs+1793)
...
#endif
#define VER_DESC        (tpmtool_opt_strs+1803)
#define VER_name        (tpmtool_opt_strs+1839)
/*
 ...
 */
#define zPROGNAME       (tpmtool_opt_strs+1847)
#define zUsageTitle     (tpmtool_opt_strs+1855)
#define zRcName         NULL
#define apzHomeList     NULL
#define zBugsAddr       (tpmtool_opt_strs+1953)
#define zExplain        (tpmtool_opt_strs+1972)
#define zDetail         (tpmtool_opt_strs+1975)
#define zFullVersion    (tpmtool_opt_strs+2044)
...
#define tpmtool_short_usage (tpmtool_opt_strs+2059)
